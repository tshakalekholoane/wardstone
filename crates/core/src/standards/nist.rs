...
/// use wardstone_core::primitives::ecc::P224;
...
/// ```
/// use wardstone_core::context::Context;
/// use wardstone_core::primitives::ffc::FFC_2048_224;
/// use wardstone_core::standards::nist;
///
/// let ctx = Context::default();
...
/// ```
/// use wardstone_core::context::Context;
/// use wardstone_core::primitives::hash::{SHA1, SHA224};
/// use wardstone_core::standards::nist;
///
/// let ctx = Context::default();
...
/// ```
/// use wardstone_core::context::Context;
/// use wardstone_core::primitives::hash::{SHA1, SHAKE128};
/// use wardstone_core::standards::nist;
///
/// let ctx = Context::default();
/// let hmac_sha1 = SHA1;
...
mod tests {
  ...
  test_case!(sha1_pre_image_resistance, validate_hash_based, &SHA1, Err(SHAKE128));
  ...
  test_case!(shake128_pre_image_resistance, validate_hash_based, &SHAKE128, Ok(SHAKE128));
  test_case!(shake256_pre_image_resistance, validate_hash_based, &SHAKE256, Ok(SHA256));
